...
| OpenCode 2 | [OpenCode 2 (preview)](https://opencode.ai/v2)        | `opencode2`    | `opencode2 auth login` |

Codex and Claude are on by default. Cursor, Grok Build, OpenCode, and OpenCode 2 are off by
