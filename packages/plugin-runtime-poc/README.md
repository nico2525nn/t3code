...
- 17 tests cover dependency order, blocking, rollback, cycles, unchanged fiber reuse, provider-value replacement, unusual ids and slots, cleanup failures, and immutable snapshots
