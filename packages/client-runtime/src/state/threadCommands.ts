...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    stopSubagent: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:stop-subagent",
      execute: (input: StopThreadSubagentInput) => stopThreadSubagent(input),
      scheduler,
      concurrency,
    }),
