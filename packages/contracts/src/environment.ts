...
export const ExecutionEnvironmentCapabilities = Schema.Struct({
  ...
  /** Server persists workspace-task tab metadata and portable context-fork
      provenance. Missing means clients must keep the legacy one-thread UI. */
  workspaceTaskTabs: Schema.optionalKey(Schema.Boolean),
