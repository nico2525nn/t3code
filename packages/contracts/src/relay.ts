...
export const RelayDeviceAuthorizationRequest = Schema.Struct({
  client_id: TrimmedNonEmptyString.annotate({
  ...
  code_challenge: TrimmedNonEmptyString.annotate({
