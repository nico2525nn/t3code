      ...
      {scrollEdges.showLeftFade ? (
        <View
          className={cn(
            ...
            props.fadeOpaque === undefined && "bg-linear-to-r from-card to-transparent",
          )}
          pointerEvents="none"
          style={{
      ...
      {scrollEdges.showRightFade ? (
        <View
          className={cn(
            ...
            props.fadeOpaque === undefined && "bg-linear-to-r from-transparent to-card",
          )}
          pointerEvents="none"
          style={{
            width: COMPOSER_TOOLBAR_FADE_WIDTH,
  ...
  return (
    <Pressable
      ...
      className={cn(
        ...
        "h-11 max-w-[172px] flex-row items-center justify-center rounded-full border shadow-lg shadow-primary-shadow/10 active:opacity-70 dark:shadow-primary-shadow/25",
      ...
      style={({ pressed }) => [
        {
          ...
          shadowOpacity: props.disabled ? 0 : undefined,
        },
        props.style,
      ]}
    >
