...
export function CompactBrandTitle(
  ...
  return (
    ...
    >
      ...
      <Text className="font-t3-medium text-[21px] tracking-[-0.5px] text-foreground-muted">
        Code
      </Text>
      <View className="rounded-full bg-subtle px-1.5 py-0.5">
        <Text className="font-t3-bold text-[9px] tracking-[0.9px] text-foreground-muted uppercase">
          {stageLabel}
        </Text>
      </View>
    </View>
