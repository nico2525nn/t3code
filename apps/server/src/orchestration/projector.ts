      ...
      return Effect.gen(function* () {
        ...
        const thread: OrchestrationThread = yield* decodeForEvent(
          OrchestrationThread,
          {
            ...
            workspaceTaskId: payload.workspaceTaskId,
            tabLabel: payload.tabLabel,
            tabPosition: payload.tabPosition,
            tabClosedAt: payload.tabClosedAt,
            forkProvenance: payload.forkProvenance,
            title: payload.title,
      ...
      return decodeForEvent(ThreadMetaUpdatedPayload, event.payload, event.type, "payload").pipe(
        Effect.map((payload) => ({
          ...
          threads: updateThread(nextBase.threads, payload.threadId, {
            ...
            ...(payload.tabPosition !== undefined ? { tabPosition: payload.tabPosition } : {}),
            ...(payload.tabClosedAt !== undefined ? { tabClosedAt: payload.tabClosedAt } : {}),
            updatedAt: payload.updatedAt,
          }),
        })),
      );
