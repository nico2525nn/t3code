import {
  ...
  ThreadNotificationDeliveredPayload as ContractsThreadNotificationDeliveredPayloadSchema,
...
export const ThreadNotificationDeliveredPayload = ContractsThreadNotificationDeliveredPayloadSchema;
