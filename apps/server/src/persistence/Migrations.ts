...
import Migration0035 from "./Migrations/035_ProjectionProjectsAgentInstance.ts";
import Migration0036 from "./Migrations/036_ProjectionThreadMessageNotification.ts";
import Migration0037 from "./Migrations/037_ProjectionThreadsLatestNotification.ts";
import Migration0038 from "./Migrations/038_BackfillProjectionThreadsLatestTurn.ts";
...
export const migrationEntries = [
  ...
  [35, "ProjectionProjectsAgentInstance", Migration0035],
  [36, "ProjectionThreadMessageNotification", Migration0036],
  [37, "ProjectionThreadsLatestNotification", Migration0037],
  [38, "BackfillProjectionThreadsLatestTurn", Migration0038],
] as const;
