...
export const makeVcsDriverShape = Effect.fn("makeGitVcsDriverShape")(function* () {
  ...
  const hasHeadCommit = (cwd: string, timeoutOrEnv?: number | NodeJS.ProcessEnv) =>
    execute({
      operation: "GitVcsDriver.checkpoints.hasHeadCommit",
      cwd,
      args: ["rev-parse", "--verify", "HEAD"],
      allowNonZeroExit: true,
      ...(typeof timeoutOrEnv === "number" ? { timeoutMs: timeoutOrEnv } : {}),
      ...(typeof timeoutOrEnv === "object" ? { env: timeoutOrEnv } : {}),
