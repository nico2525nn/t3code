...
function normalizeProviderModelOptions(
  ...
  const result: ProviderOptionSelectionsByProvider = {};
  for (const providerKey of ["codex", "claudeAgent", "cursor", "opencode", "opencode2"] as const) {
...
function legacyToModelSelectionByProvider(
  ...
  if (modelOptions) {
    for (const provider of ["codex", "claudeAgent", "cursor", "opencode", "opencode2"] as const) {
