...
interface SidebarThreadRowProps {
  ...
  openWebPort: (event: MouseEvent<HTMLElement>, port: number) => void;
...
export default function Sidebar() {
  ...
  const openWebPort = useCallback((event: MouseEvent<HTMLElement>, port: number) => {
    event.preventDefault();
    event.stopPropagation();
