  ...
  return (
    <SettingsPageContainer>
      <SettingsSection title="Beta features">
        <SettingsRow
          title="Sidebar v2"
          description="Treat sidebar items as tasks. Each task can hold multiple provider tabs that share one worktree; active work renders as rich cards and settled tasks collapse to compact rows. Switch back any time."
          control={
            <Switch
