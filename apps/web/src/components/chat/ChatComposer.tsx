    ...
    >
      ...
      >
        <div
          ...
          className={cn(
            "chat-composer-glass rounded-[19px] border transition-colors duration-200 has-focus-visible:border-foreground/40",
            isDragOverComposer
        ...
        >
          {!isComposerCollapsedMobile &&
            (activePendingApproval ? (
              <div className="rounded-t-[18px] border-b border-border/65 bg-muted/20">
          ...
          {isComposerCollapsedMobile && activePendingApproval ? (
            <div
              className="rounded-t-[18px] border-b border-border/65 bg-muted/20"
